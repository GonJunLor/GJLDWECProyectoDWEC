...
<body>
    ...
    <nav>
        ...
        <h2>DWEC Desarrollo web en entorno cliente</h2>
        ...
        <section>
            ...
            <div>
                <article class="practica">
                    <iframe src="../GJLDWECSopaLetras/indexSopaLetras.html"></iframe>
                    <a href="../GJLDWECSopaLetras/indexSopaLetras.html" target="_blank">
